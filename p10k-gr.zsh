# Generated by Powerlevel10k configuration wizard on 2021-11-16 at 19:50 EET.
...
# blurred tails, 1 line, sparse, fluent, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%F{042}󰯿󰰠-󰲪󰲤%F{042} '
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%F{042}󰫤%F{042}'
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=33
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=42
